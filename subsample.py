...
def subsample(directory):
	...
	for condition in conditions: 
		...
		if traj_dir.split('-')[1] not in ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J']:
			continue
		...
		traj_files = get_trajectory_files(traj_dir)[0:3]
		...
		pool.map(read_and_save_traj, traj_files)				


#subsample("/home/harrigan/compute/wetmsm/gpcr/des/system_mae_to_pdb/des_trajs")
featurize("/scratch/users/enf/b2ar_analysis/subsampled")
